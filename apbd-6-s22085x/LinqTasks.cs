...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = from e in Emps
                ...
                group e by d.Dname into grouped
        ...
        {
            IEnumerable<Emp> result = Emps.GetManagersWithAtLeastOneSubordinateNameAscSalaryDesc();
            return result;
        }
        ...
        {
            int result = arr.GroupBy(i => i) // grupowanie po wartości
                .Where(group => group.Count() % 2 == 1) // zostawiam tylko te grupy, które mają nieparzystą liczbę elementów 
                .First() // biorę pierwszą z nich (czyli jedyną zgodnie z założeniem)
                .Key; // biorę wartość z tej grupy
            //result=
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Emps.GroupBy(e => e.Deptno)
                .Where(group => group.Count() == 5 || group.Count() == 0)
                .Select(group => group.First().Deptno)
                .Join(Depts, deptno => deptno, dept => dept.Deptno, (deptno, dept) => dept)
    ...
    public static class CustomExtensionMethods
    {
        ...
        // task 12
        public static IEnumerable<Emp> GetManagersWithAtLeastOneSubordinateNameAscSalaryDesc(this IEnumerable<Emp> emps)
        {
            var result = emps.Where(manager => emps.Where(employee => manager.Equals(employee.Mgr)).Count() > 0)
                .OrderBy(e => e.Ename)
                .ThenByDescending(e => e.Salary)
                .ToList();
            return result;
